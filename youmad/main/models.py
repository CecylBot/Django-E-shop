...
class AdminInformations(models.Model):
    ...
    logo = models.ImageField(upload_to='admin_info_logos/')
...
def update_order_price(sender, instance, **kwargs):
    ...
    html_template = get_template('main/x.html')
    ...
    with open(pdf_save_path, 'wb') as f:
        pisaStatus = pisa.CreatePDF(StringIO(str(rendered_html)), dest=f, encoding='UTF-8')
